...
| **[anime-hdr]** | High Dynamic Range (HDR) Anime | Builds on the anime profile but adds true</br>HDR passthrough for vibrant colors and</br>brightness on compatible displays. |
